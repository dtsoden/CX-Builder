...
// Upstream Flowise ships an AnnouncementBanner here announcing its own sunset.
// CX-Builder is a separate product, so the banner is not rendered and the offset
// it reserved is always zero.
const BANNER_OFFSET = 0
...
const MainLayout = () => {
    ...
    const bannerOffset = BANNER_OFFSET
