...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/gh/dtsoden/cx-builder-embed@main/dist/web.js"
    Chatbot.init({
...
export const defaultThemeConfig = {
    button: {
        ...
        dragAndDrop: true,
        iconColor: 'white',
        customIconSrc: 'https://cdn.jsdelivr.net/gh/dtsoden/webresources@main/google-messages-icon.svg',
        autoWindowOpen: {
            autoOpen: true,
            openDelay: 2,
    ...
    tooltip: {
        showTooltip: true,
        tooltipMessage: 'Foo says hello 👋!',
        tooltipBackgroundColor: 'black',
        tooltipTextColor: 'white',
        tooltipFontSize: 16
    },
    disclaimer: {
        title: 'Example and optional disclaimer',
    ...
    chatWindow: {
        ...
        title: 'CX-Builder Bot',
        titleAvatarSrc: 'https://cdn.jsdelivr.net/gh/dtsoden/webresources@main/cx-builder/cx-avitar.png',
        welcomeMessage: 'Hello! welcome to the enchanted world of Foo Schnickens',
        ...
        starterPrompts: [
            ...
            'Summarize the story as a cliff note.',
        ...
        botMessage: {
            ...
            textColor: '#303235',
            showAvatar: true,
            avatarSrc: 'https://cdn.jsdelivr.net/gh/dtsoden/webresources@main/cx-builder/cx-avitar.png'
        },
        userMessage: {
            backgroundColor: '#3B81F6',
            textColor: '#ffffff',
            showAvatar: true,
            avatarSrc: 'https://cdn.jsdelivr.net/gh/dtsoden/webresources@main/cx-builder/user_avitar.png'
        },
        textInput: {
            ...
            sendSoundLocation: 'https://cdn.jsdelivr.net/gh/dtsoden/webresources@main/cx-builder/send_message.mp3',
            receiveMessageSound: true,
            receiveSoundLocation: 'https://cdn.jsdelivr.net/gh/dtsoden/webresources@main/cx-builder/receive_message.mp3'
        },
        feedback: {
            color: '#303235'
        },
        ...
        footer: {
            ...
            text: 'Powered by',
            company: 'CX-Builder',
            companyLink: 'https://cx-builder.com'
        }
    }
}
