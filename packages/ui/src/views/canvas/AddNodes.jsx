...
const AddNodes = ({ nodesData, node, isAgentCanvas, isAgentflowv2, onFlowGenerated }) => {
    ...
    const handleOpenDialog = () => {
        ...
        setDialogProps({
            ...
            description:
                `Enter your prompt to generate an ${agentflowLabel}. Performance may vary with different models. Only nodes and edges are generated, you will need to fill in the input fields for each node.`
        })
    }
