                ...
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    ...
                    {agentflowVersion === 'v1' && showDeprecationNotice && (
                        ...
                        >
                            ...
                            />
                            <Box sx={{ flex: 1 }}>
                                <strong>V1 {agentflowTitle} are deprecated.</strong> We recommend migrating to V2 for improved performance and
                                continued support.
                            </Box>
                            <IconButton
                                aria-label='dismiss'
                    ...
                    {!isLoading && total === 0 && (
                        <Stack sx={{ alignItems: 'center', justifyContent: 'center' }} flexDirection='column'>
                            <Box sx={{ p: 2, height: 'auto' }}>
                                <EmptyStateImage alt={`No ${agentflowTitle}`} />
                            </Box>
                            <div>No {agentflowTitle} Yet</div>
                        </Stack>
                    )}
                </Stack>
            )}
