                                    ...
                                    {col === 'enabled' ? (
                                        <>
                                            ...
                                            <TooltipWithParser
                                                ...
                                                title={`If enabled, this variable can be overridden in API calls and embeds. If disabled, any overrides will be ignored. To change this, go to Security settings in ${chatflowLabel} Configuration.`}
                                            />
                                        </>
                                    ) : (
